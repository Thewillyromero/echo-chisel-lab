  ...
  return (
    <section className="py-24 px-6">
      <div className="container mx-auto max-w-3xl">
        <div className="glass rounded-2xl p-8 md:p-12 text-center glow-box-strong">
          ...
          <div className="text-sm text-muted-foreground">
            <span className="text-foreground font-semibold">José Luis Perdomo</span> · Fundador de VoxAI
          </div>
