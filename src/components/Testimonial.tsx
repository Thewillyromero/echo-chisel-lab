...
const testimonials = [
  ...
  { quote: "En 14 días ya habíamos generado $7,200 en nuevos clientes. Las llamadas de seguimiento automáticas fueron la clave del cierre.", name: "Michael Torres", role: "Propietario", company: "Advanced Plumbing", initials: "MT", result: "$7.2K en 14 días", context: "Servicios", avatar: avatarMichael },
