...
const reviews = [
  { text: "CALLA ha transformado nuestra atención al cliente. Ya no perdemos ni una llamada.", author: "María L.", role: "Clínica dental", avatar: avatarSergio },
  { text: "Impresionante. Duplicamos citas en el primer mes.", author: "Javier R.", role: "Inmobiliaria", avatar: avatarElena },
  ...
  { text: "Recuperamos 15 llamadas perdidas al día. Literalmente nos paga solo.", author: "Antonio G.", role: "Taller mecánico", avatar: avatarRoberto },
    ...
    >
      <div className="container mx-auto">
        <motion.div
          ...
          className="bg-card/30 border border-border/20 rounded-2xl p-5 md:p-6 hover:border-border/30 transition-all duration-300"
        >
              ...
              >
                ...
                <div className="flex items-center gap-2 mt-auto">
                  ...
                  <p className="text-[10px] text-muted-foreground">
                    <span className="font-semibold text-foreground/60">{r.author}</span> · {r.role}
                  </p>
                </div>
              </motion.div>
            ))}
