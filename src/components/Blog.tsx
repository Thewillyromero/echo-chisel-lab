      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          <div className="lg:flex-1">
            ...
            <h2 className="text-3xl md:text-5xl font-display font-extrabold mb-4 tracking-tight text-glow">
              Infórmate de nuestros <span className="text-gradient text-glow-teal">avances</span>
            </h2>
          </div>
        </motion.div>
